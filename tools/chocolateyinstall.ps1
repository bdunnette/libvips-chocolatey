...
$url64 = 'https://github.com/libvips/libvips/releases/download/v' + $env:ChocolateyPackageVersion + '/vips-dev-w64-all-' + $env:ChocolateyPackageVersion + '.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
    ...
    softwareName   = 'libvips*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
