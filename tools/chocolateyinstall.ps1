...
$url64      = 'https://github.com/jcupitt/libvips/releases/download/v8.6.3/vips-dev-w64-all-8.6.3-1.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
